...
(function(){
    ...
    function Todo(){
        /* dohvaćanje pojedinih HTML elemenata: konstante dostupne samo unutar funkcije Todo() */
        const polje = document.querySelector("input"), 
        gumbicDodaj = document.querySelector("button"),
        lista = document.querySelector("ul");

        /* deklaracija funkcija za upravljanje listom: dostupne samo unutar funkcije Todo() */
    ...
    /* poziv metode init() - nakon što se učita cijela stranica, uključujući vanjske resurse */
